...
---
The HTSeq counts files are located in the Counts directory. 
Note: the counts files are from mapping to the entire Mouse Genome. Only Chromosome 1 was used for mapping for computational efficiency
...
directory <- "~/Documents/Transcriptomics/DifferentialExpression_Tuturial/Counts/"
...
```{r, eval = FALSE}
sampleCondition<- read.table("~/Documents/Transcriptomics/DifferentialExpression_Tuturial/Conditions.txt",head=TRUE) #file with sample data to be compared
sampleCondition
...
```{r, eval = FALSE}
vsd2 <- vsd[,vsd$condition.SampleID != "CGCAATTC"]
...
mmGenes = read.table("~/Documents/Transcriptomics/DifferentialExpression_Tuturial/MouseGeneTable.txt", header=TRUE, row.names = 1)
...
write.table(res.dds,file="~/Documents/Transcriptomics/DifferentialExpression_Tuturial/FF_vs_Cre.DESeq.out.txt",quote=F,sep="\t")
```
...
head(RNK)
write.table(RNK, "~/Documents/Transcriptomics/DifferentialExpression_Tuturial/FF_vs_Cre.DESeq.rnk",quote=F,sep="\t", row.names = F)
...
head(counts)
write.table(counts,"~/Documents/Transcriptomics/DifferentialExpression_Tuturial/CountsTable.txt",quote=F,sep="\t")
```